	...
	testCases := []struct {
	...
	}{
		{
			...
			input: dto.CreateTemplateBlockDTO{
				...
				BlockOrder:               1,
				ExerciseCount:            3,
				EstimatedDurationMinutes: func() *int { v := 15; return &v }(),
				Instructions:             func() *string { v := "Light warm-up exercises"; return &v }(),
				Reps:                     func() *int { v := 10; return &v }(),
				Series:                   func() *int { v := 2; return &v }(),
				RestTimeSeconds:          func() *int { v := 30; return &v }(),
				CreatedBy:                "admin-123",
			},
			setupMock: func(mockService *MockTemplateBlockService) {
				id := "block-123"
				mockService.On("CreateTemplateBlock", mock.AnythingOfType("*dto.CreateTemplateBlockDTO")).Return(&id, nil)
			},
		...
		},
		{
			...
			setupMock: func(mockService *MockTemplateBlockService) {
				mockService.On("CreateTemplateBlock", mock.AnythingOfType("*dto.CreateTemplateBlockDTO")).Return(
					(*string)(nil), apierror.New(errorcode_enum.CodeConflict, "Template block with name 'Warm-up' already exists in template", nil),
				)
			},
			...
			setupMock: func(mockService *MockTemplateBlockService) {
				blocks := []*dto.TemplateBlockDTO{
					...
					},
					{
						...
						BlockOrder:               2,
						ExerciseCount:            5,
						EstimatedDurationMinutes: func() *int { v := 45; return &v }(),
						Instructions:             func() *string { v := "Core workout exercises"; return &v }(),
						Reps:                     func() *int { v := 12; return &v }(),
						Series:                   func() *int { v := 3; return &v }(),
						RestTimeSeconds:          func() *int { v := 60; return &v }(),
						CreatedAt:                "2023-01-01T00:00:00Z",
						CreatedBy:                "admin-123",
					},
				}
	...
	testCases := []struct {
	...
	}{
		{
			...
			input: dto.UpdateTemplateBlockDTO{
				...
				Instructions:             stringPtr("Updated warm-up instructions"),
				Reps:                     intPtr(15),
				Series:                   intPtr(3),
			...
			setupMock: func(mockService *MockTemplateBlockService) {
				updatedBlock := &dto.TemplateBlockDTO{
					...
					BlockOrder:               1,
					ExerciseCount:            5,
					EstimatedDurationMinutes: func() *int { v := 20; return &v }(),
					Instructions:             func() *string { v := "Updated warm-up instructions"; return &v }(),
					Reps:                     func() *int { v := 15; return &v }(),
					Series:                   func() *int { v := 3; return &v }(),
					RestTimeSeconds:          func() *int { v := 45; return &v }(),
					CreatedAt:                "2023-01-01T00:00:00Z",
					CreatedBy:                "admin-123",
				}
